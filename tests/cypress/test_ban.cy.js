describe("template spec", () => {
    it("passes", () => {
        ...
        cy.get(
            ":nth-child(1) > :nth-child(1) > .justify-center > :nth-child(2) > .mt-2",
        ).click();
        ...
        cy.get(".Toastify__toast-body > :nth-child(2)")
            ...
            .then((element) => {
                if (element.text().includes("User banned")) {
                    cy.contains("User banned")
                        .should("exist")
                        .should("be.visible");
                } else if (
                    element.text().includes("This user is already banned")
                ) {
                    cy.contains("This user is already banned")
                        .should("exist")
                        .should("be.visible");
                }
            });
        ...
        cy.get(":nth-child(1) > .inline-flex > .text-white-500")
            .should("exist")
            .click();
